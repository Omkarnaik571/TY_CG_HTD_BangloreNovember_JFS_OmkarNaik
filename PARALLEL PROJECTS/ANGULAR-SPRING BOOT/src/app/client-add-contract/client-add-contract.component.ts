...
@Component({
  selector: 'app-client-add-contract',
  templateUrl: './client-add-contract.component.html',
  styleUrls: ['./client-add-contract.component.css']
})
export class ClientAddContractComponent implements OnInit {

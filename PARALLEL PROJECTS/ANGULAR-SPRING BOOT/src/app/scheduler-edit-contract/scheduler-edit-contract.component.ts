...
@Component({
  selector: 'app-scheduler-edit-contract',
  templateUrl: './scheduler-edit-contract.component.html',
  styleUrls: ['./scheduler-edit-contract.component.css']
})
export class SchedulerEditContractComponent implements OnInit {
  ...
  updateContract(editContractForm){
    this.log.updateContract(editContractForm.value).subscribe(data=>{
          if(data.statuscode === 200){
           ...
           this.route.navigateByUrl('/scheduler-other-contract-operation');
          }
    });
  }

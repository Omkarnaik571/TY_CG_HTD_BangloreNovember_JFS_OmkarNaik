...
import com.capgemini.forestmanagementsystemusingspringboot.service.AuthenticationService;
...
public class AuthenticationController {
	...
	public AuthenticationResponse deleteUser(@RequestBody AuthenticationDetailsDto bean) {
		...
		if (authenticationService.delateUser(bean)) {
			// Added successfully
			response.setStatuscode(200);
			response.setMessage("User deleated succefully !!");
	...
	public List<AuthenticationDetailsDto> viewAllUsers() {
		AuthenticationResponse response = new AuthenticationResponse();

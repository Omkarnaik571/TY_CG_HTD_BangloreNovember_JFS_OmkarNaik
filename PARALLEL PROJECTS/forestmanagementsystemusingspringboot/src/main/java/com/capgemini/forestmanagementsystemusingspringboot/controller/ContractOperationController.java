...
import com.capgemini.forestmanagementsystemusingspringboot.dto.ContractResponse;
	...
	ContractService contractService;
 	...
 	public ContractResponse addContract(@RequestBody ContractorDetailsDto bean) {
 		...
 		if (contractService.addContractor(bean)) {
 			...
 			response.setMessage("Either the product id or the customer id that you have entered does`nt exists !!");

...
public class Validations {
	...
	public static boolean isvalidUserName(String userName) {
		...
		if( firstLetter == '1' || firstLetter == '2' || firstLetter == '3' || firstLetter == '4'
			|| firstLetter == '5' || firstLetter == '6' ||firstLetter == '7' ||firstLetter == '8' ||firstLetter == '9' ||firstLetter =='0' ||	
			firstLetter == '!' || firstLetter == '@' || firstLetter == '#' || firstLetter == '$' || firstLetter == '%' || firstLetter == '&' || firstLetter == '`' || firstLetter == '~' || firstLetter == '*' 		
				) {
			return false;
		}
		
		return true;
	}//end of isValidUserName..
	
		
	
	public static boolean isValidUserType(String userType) {
		if(userType.toLowerCase().equals("client") || userType.toLowerCase().equals("scheduler")) {
			return true;
		}
		
		return false;
	}//end of isValidUserType

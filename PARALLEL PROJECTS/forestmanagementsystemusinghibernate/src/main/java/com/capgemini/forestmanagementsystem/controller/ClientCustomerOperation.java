...
public class ClientCustomerOperation {
	...
	public static void clientCustomerOperation() {
		...
		while(true) {
			...
			System.out.println("Press 2 to view a particular Customer Detail ");	
			System.out.println("Press 3 to delete a Customer");
			System.out.println("Press 4 to Modify a Customer");
			System.out.println("press 5 GO BACK TO ADMIN PAGE");
				...
				case 5:
					...
					while(k1=='y') {
						...
						if(Validations.isValid(memail)) {
							...
							System.err.println("E-mail must be of lower case only  !!");
							System.err.println(" must contain an @ symbol followed by mail address !!");
						}
					}     
					cd.setEmail(memail);

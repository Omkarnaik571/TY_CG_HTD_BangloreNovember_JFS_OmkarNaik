...
public static void clientCustomerOperation() {
		...
		while(true) {
			...
			case 1:
				...
				try {
					if(customerService.addCustomer(cd)) {
			...
			case 3:
				...
				try {
					CustomerDetail singleCustomer=customerService.getSingleCustomer(Integer.parseInt(dc1));
			...
			case 4:
				...
				try {
					if(customerService.removeCustomer(id1)) {
			...
			case 5:
				...
				try {
					modify = customerService.getSingleCustomer(id2);
				...
				if(modify!=null) {
					...
					case 1:
						...
						try {
							customerService.modifyCustomer(id2, modify);
